...
void SimMibLeaf::set_config_mode() { configMode = true; }

void SimMibLeaf::unset_config_mode() { configMode = false; }

bool SimMibLeaf::get_config_mode() { return configMode; }
...
time_t simSysUpTime::get() { return (get_currentTime() - start) * 100; }

...
inline OidxPtrMibEntryPtrAVLNode::OidxPtrMibEntryPtrAVLNode(OidxPtr h,
    MibEntryPtr c, OidxPtrMibEntryPtrAVLNode* l, OidxPtrMibEntryPtrAVLNode* r)
...
inline Pix OidxPtrMibEntryPtrAVLMap::last() { return Pix(rightmost()); }

...
public:
     ...
     *    a variable binding.
     */
    Vbx get_original_value(unsigned int i) { return originalVbs[i]; }
     ...
     * @return A request id.
     */
    uint32_t get_request_id() { return pdu->get_request_id(); }
     ...
     */
    void set_transaction_id(uint32_t id) { transaction_id = id; }
...
public:
     ...
     *         not have been found.
     */
    virtual uint32_t get_request_id(const Vbx&);
     ...
     */
    virtual void error(uint32_t, int, int);
     ...
     */
    virtual Request* get_request(uint32_t);
     ...
     */
    virtual Request* find_request_on_id(uint32_t);
     ...
     */
    uint32_t create_transaction_id() { return next_transaction_id++; }
     ...
     */
    uint32_t size() { return requests->size(); }
